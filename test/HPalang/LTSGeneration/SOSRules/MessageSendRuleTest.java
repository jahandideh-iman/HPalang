...
public class MessageSendRuleTest extends SOSRuleTestFixture
{
    ...
    {  
        ...
        MessagePacket expectedPacket = MessagePacketFor(sender, sendStatement);
        ClearStatementsFor(FindActorState(sender, expectedGlobalState));
        PutMessagePacketInActor(FindActorState(receiver, expectedGlobalState), expectedPacket);
    ...
    public void SendsMessagePacketToCanNetworkIfCommunicationTypeIsCAN()
    {
        ...
        MessagePacket expectedPacket = MessagePacketFor(sender, sendStatement);
        ClearStatementsFor(FindActorState(sender, expectedGlobalState));
        PutMessagePacketNetworkState(expectedPacket, expectedGlobalState);
    ...
    public void AddsArgumentsValuesToMessageIfArgumentsAreComputable()
    {
        ...
        VariableArgument expectedArgument =  FindLastPacket(receiverState.Actor(),transitionCollectorMock.collectedState).
    ...
    public void AddsArgumentsPartialValuesToMessageIfArgumentsAreComputable()
    {
        ...
        VariableParameter parameter = new VariableParameter(new EmptyVariable("param"));
