...
public class GlobalRunTimeStateBuilder
{
    ...
    public GlobalRunTimeState Build()
    {
        ...
        //actorRunTimeStates.forEach((state)->globalState.AddPhysicalActorState(state));
        //actorRunTimeStateBuilders.forEach((builder) -> globalState.AddPhysicalActorState(builder.Build()));
