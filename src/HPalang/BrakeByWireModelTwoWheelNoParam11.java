 ...
 */
public class BrakeByWireModelTwoWheelNoParam11
{
    public static final float arbitrartDelay = 13.0f;
    public static final String Wheel__controller_instance = "controller"; 
    public static final String Wheel__brake_controller_instance = "brakeController";
    public static final String Wheel__go_to_brake = "goToBrake";
    ...
    public static final String Wheel_Controller__brake_percent_port = "brake_percent_port";
    public static final String Wheel_Controller__control_handler = "control";
    ...
    public static ModelDefinition Create()
    {
        ...
        FillSkeletonForWheelType(wheelType, wheelControllerType, globalBrakeControllerType);
        ...
        SoftwareActor wheel_controller_FL = new SoftwareActor("wheel_controller_FL",wheelControllerType, 1);
        ...
        FillWheelActor(
                ...
                Global_Brake_Controller__wheel_rpm_FR_port,
                CommunicationType.CAN);
        FillWheelActor(wheel_FL,
                wheel_controller_FL,
                global_brake_controller,
                Global_Brake_Controller__wheel_rpm_FR_port,
                CommunicationType.CAN);
        ...
        //SetNetworkDelay(definition, clock, global_brake_controller, Global_Brake_Controller__control_handler, CAN__dealy_const);
        //SetNetworkPriority(definition, global_brake_controller, Global_Brake_Controller__control_handler,8);

        SetNetworkDelay(definition, wheel_FR, global_brake_controller, Global_Brake_Controller__wheel_rpm_FL_port, CAN__dealy_const);
        SetNetworkDelay(definition, wheel_FL, global_brake_controller, Global_Brake_Controller__wheel_rpm_FR_port, CAN__dealy_const);
    ...
    private static void FillSkeletonForWheelType(PhysicalActorType wheelType, ActorType wheelControllerType, ActorType brakeControllerType)
    {
        wheelType.AddInstanceParameter(new InstanceParameter(Wheel__controller_instance, wheelControllerType));
        wheelType.AddInstanceParameter(new InstanceParameter(Wheel__brake_controller_instance, brakeControllerType));
        ...
        AddMessageHandler(wheelType, Wheel__torque_port, Message.MessageType.Data);
    ...
    private static void FillFleshForWheelType(PhysicalActorType wheelType, MessageHandler wheel_speed_port)
    {
        ...
        InstanceParameter brakeControllerInstance = wheelType.FindInstanceParameter(Wheel__brake_controller_instance); 
...
//        //noBrakeMode.AddAction(CreateSendStatement(controllerInstance, Wheel_Controller__wheel_speed_port));   
//        noBrakeMode.AddAction(CreateSendStatement(brakeControllerInstance, Global_Brake_Controller__wheel_rpm_FL_port));
...
//        noBrakeMode.AddAction(CreateModeChangeStatement(noBrakeMode));
        ...
        brakeMode.AddAction(CreateSendStatement(brakeControllerInstance, Global_Brake_Controller__wheel_rpm_FL_port));
...
//        AddParameter(applyTorque, "vehicle_speed", FloatVariable.class);
        ...
        AddMessageHandler(wheelControllerType, Wheel_Controller__wheel_speed_port, Message.MessageType.Data);
        AddMessageHandler(wheelControllerType, Wheel_Controller__brake_percent_port, Message.MessageType.Data);
        AddMessageHandler(wheelControllerType, Wheel_Controller__control_handler, Message.MessageType.Data);
    }
...
//                                Const(0.0f))),
//                Statement.StatementsFrom(new AssignmentStatement(slip_rate, Const(2.0f))), 
//                Statement.StatementsFrom(
//                        //new AssignmentStatement(slip_rate, Const(1.0f)),
//                        //CreateSendStatement(wheel, wheel_torque_port)
//                        //CreateModeChangeSendStatement(brakeMode, new ParametricActorLocator(wheel))
//                        )
//        ));
                
        //applyTorque.AddStatement(CreateSendStatement(wheel, wheel_torque_port ));  
        //applyTorque.AddStatement(CreateSendStatement(wheel, wheel_torque_port ));  
        //applyTorque.AddStatement(CreateModeChangeSendStatement(brakeMode, new ParametricActorLocator(wheel)));
        ...
        applyTorque.AddStatement(new IfStatement(
                 new BinaryExpression(
                        ...
                        new BinaryExpression(
                                ...
                                new EqualityOperator(),
                                Const(0.0f))),
                Statement.StatementsFrom(CreateSendStatement(wheel, wheel_torque_port)), 
                Statement.StatementsFrom(
                        CreateSendStatement(wheel, wheel_torque_port ))
        ));
    ...
    private static void FillSkeletonForGlobalBrakeControllerType(SoftwareActorType globalBrakeControllerType, SoftwareActorType wheelControllerType)
    {
        ...
        AddDataMessageHandler(globalBrakeControllerType, Global_Brake_Controller__wheel_rpm_FR_port);
        AddDataMessageHandler(globalBrakeControllerType, Global_Brake_Controller__wheel_rpm_FL_port);
        //AddDataMessageHandler(globalBrakeControllerType, Global_Brake_Controller__brake_percent_port);
...
//        
        control.AddStatement(CreateSendStatement(wheel_controller_FR, wheelControllerApply));
        control.AddStatement(CreateSendStatement(wheel_controller_FL, wheelControllerApply));
    }
            ...
            CommunicationType type)
    {
        ...
        BindInstance(wheel,Wheel__brake_controller_instance, global_brake_controller, CommunicationType.Wire );
        BindDelagation(wheel, Wheel__speed_delegation, global_brake_controller, delegationHandlerName, type);
    }
