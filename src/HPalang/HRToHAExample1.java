...
public class HRToHAExample1
{
    ...
    private static void FillSkeletonForAType(SoftwareActorType AType, SoftwareActorType BType)
    {
        ...
        AddParameter(X1, A__X1_r, IntegerVariable.class);
    }
    ...
    private static void FillFleshForBType(SoftwareActorType BType)
    {
        ...
        Y1.AddStatement(CreateSendStatement(aIns, A__X1_handler, new ConstantDiscreteExpression(2)));
    }
}
