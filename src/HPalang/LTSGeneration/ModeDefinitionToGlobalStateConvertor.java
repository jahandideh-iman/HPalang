...
public class ModeDefinitionToGlobalStateConvertor
{
    public GlobalRunTimeState Convert(ModelDefinition model)
    {
        ...
        globalState.EventsState().PoolState().SetPool(new SimpleContinuousVariablePool(50));
        globalState.VariablePoolState().SetPool(new SimpleContinuousVariablePool(50));
